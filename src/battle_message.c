...
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_NAME_WITH_CLASS}と {B_TRAINER2_NAME_WITH_CLASS}に\nまけた...…");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNUSEDXTOGETPUMPED]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_LAST_ITEM}で\nきあいを ためた！"),
    ...
    [STRINGID_POKEFLUTECATCHY]                      = COMPOUND_STRING("{JPN}{B_PLAYER_NAME}は {B_LAST_ITEM}を ふいた。\pなんとも ここちよい メロディだ！"),
    [STRINGID_POKEFLUTE]                            = COMPOUND_STRING("{JPN}{B_PLAYER_NAME}は {B_LAST_ITEM}を ふいた。"),
    [STRINGID_MONHEARINGFLUTEAWOKE]                 = COMPOUND_STRING("{JPN}ふえの おとを きいた ポケモンは\nめを さました！"),
    ...
    [STRINGID_WAGGLINGAFINGER]                      = COMPOUND_STRING("{JPN}ゆびをふって {B_CURRENT_MOVE}を くりだした！"),
    ...
    [STRINGID_QUESTIONFORFEITBATTLE]                = COMPOUND_STRING("{JPN}このバトルを こうさんしますか？\nバトルを やめると まけたことに なります。"),
    ...
    [STRINGID_MONTOOSCAREDTOMOVE]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nこわくて うごけない！"),
    [STRINGID_GHOSTGETOUTGETOUT]                    = COMPOUND_STRING("{JPN}ゆうれい: でていけ...... でていけ......"),
    [STRINGID_SILPHSCOPEUNVEILED]                   = COMPOUND_STRING("{JPN}シルフスコープが ゆうれいの\nしょうたいを あばいた！"),
    [STRINGID_GHOSTWASMAROWAK]                      = COMPOUND_STRING("{JPN}ゆうれいの しょうたいは ガラガラだった！\p"),
...
const u8 gText_PkmnStoppedEvolving[] = _("おや？ {STR_VAR_1}の\nしんかが とまった！\p");
...
const u8 gText_TheGreatNewHope[] = _("あらたな きぼう！\p");
const u8 gText_WillChampionshipDreamComeTrue[] = _("ゆうしょうの ゆめは かなうのか！？\p");
const u8 gText_AFormerChampion[] = _("かつての チャンピオン！\p");
const u8 gText_ThePreviousChampion[] = _("ぜんかいの チャンピオン！\p");
const u8 gText_TheUnbeatenChampion[] = _("むはいの チャンピオン！\p");
...
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS}は\n{B_OPPONENT_MON1_NAME}を くりだした！\p{B_TRAINER2_NAME_WITH_CLASS}は\n{B_OPPONENT_MON2_NAME}を くりだした！");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_NAME_WITH_CLASS}は {B_BUFF1}を くりだした！");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS}と {B_TRAINER2_NAME_WITH_CLASS}が\nしょうぶを しかけてきた！\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_NAME_WITH_CLASS}は\n{B_PLAYER_MON2_NAME}を くりだした！ ゆけっ！ {B_PLAYER_MON1_NAME}！");
static const u8 sText_InGamePartnerSentOutNGoZ[] = _("{B_PARTNER_NAME_WITH_CLASS}は\n{B_PLAYER_MON1_NAME}を くりだした！ ゆけっ！ {B_PLAYER_MON2_NAME}！");
static const u8 sText_InGamePartnerSentOutPkmn1[] = _("{B_PARTNER_NAME_WITH_CLASS}は {B_PLAYER_MON1_NAME}を くりだした！");
static const u8 sText_InGamePartnerSentOutPkmn2[] = _("{B_PARTNER_NAME_WITH_CLASS}は {B_PLAYER_MON2_NAME}を くりだした！");
static const u8 sText_InGamePartnerWithdrewPkmn1[] = _("{B_PARTNER_NAME_WITH_CLASS}は {B_PLAYER_MON1_NAME}を ひっこめた！");
static const u8 sText_InGamePartnerWithdrewPkmn2[] = _("{B_PARTNER_NAME_WITH_CLASS}は {B_PLAYER_MON2_NAME}を ひっこめた！");
...
{
    [B_MSG_REF_NOTHING_IS_DECIDED] = COMPOUND_STRING("{JPN}レフェリー: 3ターンで きまらないときは\nはんていに うつります！"),
    [B_MSG_REF_THATS_IT]           = COMPOUND_STRING("{JPN}レフェリー: そこまで！\nこれより はんていで\nしょうしゃを きめます！"),
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("{JPN}レフェリー: はんてい その1 こころ！\nもっとも きあいを みせた ポケモン！\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("{JPN}レフェリー: はんてい その2 わざ！\nもっとも じょうずに わざを つかった ポケモン！\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("{JPN}レフェリー: はんてい その3 からだ！\nもっとも たいりょくを のこした ポケモン！\p"),
    [B_MSG_REF_PLAYER_WON]         = COMPOUND_STRING("{JPN}レフェリー: はんてい！\n{B_BUFF1}たい{B_BUFF2}！ しょうしゃは\n{B_PLAYER_NAME}の {B_PLAYER_MON1_NAME}！\p"),
    [B_MSG_REF_OPPONENT_WON]       = COMPOUND_STRING("{JPN}レフェリー: はんてい！\n{B_BUFF1}たい{B_BUFF2}！ しょうしゃは\n{B_TRAINER1_NAME}の {B_OPPONENT_MON1_NAME}！\p"),
    [B_MSG_REF_DRAW]               = COMPOUND_STRING("{JPN}レフェリー: はんてい！ 3たい3！\nひきわけです！\p"),
    [B_MSG_REF_COMMENCE_BATTLE]    = COMPOUND_STRING("{JPN}レフェリー: {B_PLAYER_MON1_NAME} VS\n{B_OPPONENT_MON1_NAME}！ しょうぶ かいし！"),
};

static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE}{B_TRAINER1_NAME_WITH_CLASS}は にげだした！");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("{B_TRAINER1_NAME_WITH_CLASS}に まけた！");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("{B_TRAINER1_NAME_WITH_CLASS}と ひきわけた！");
const u8 gText_RecordBattleToPass[] = _("このバトルを\nフロンティアパスに きろくしますか？");
const u8 gText_BattleRecordedOnPass[] = _("{B_PLAYER_NAME}の バトルけっかを\nフロンティアパスに きろくした。");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{B_LINK_OPPONENT1_NAME}が しょうぶを しかけてきた！\p");
