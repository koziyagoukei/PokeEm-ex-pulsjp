...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{JPN}{B_BUFF1}は レベル{B_BUFF2} に あがった！{WAIT_SE}"),
    ...
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}おぼえずに おわった!"),
    ...
    [STRINGID_ORICHALCUMPULSEACTIVATES] = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の こだいのこどうが\nあばれだす！"),
    [STRINGID_HADRONENGINEACTIVATES] = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の ハドロンエンジンで\nみらいきかんが やくどうする！"),
